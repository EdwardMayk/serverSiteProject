...
import { doublePrecision, pgTable, integer, serial, text, varchar } from "drizzle-orm/pg-core"


export const products = pgTable('products',{
    id: serial('id').primaryKey(),
    product_name: varchar('product_name', {length: 155}).notNull(),
    product_category: varchar('product_category', {length: 155}).notNull(),
